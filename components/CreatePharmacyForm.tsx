...
const CreatePharmacyForm: React.FC<{ user: any }> = ({ user }) => {
    ...
    const handleInputChange = (name: string, value: any) => {
        if (name === 'operatingHoursOpen' || name === 'operatingHoursClose') {
            setPharmacyForm({
                ...pharmacyForm,
                operatingHours: {
                    ...pharmacyForm.operatingHours,
                    [name === 'operatingHoursOpen' ? 'open' : 'close']: value
                }
            });
        } else {
            setPharmacyForm({ ...pharmacyForm, [name]: value });
        }
    };
    ...
    const handleCreatePharmacy = async () => {
        try {
            ...
            formData.append('operatingHours', JSON.stringify(pharmacyForm.operatingHours));
    ...
    return (
        <View style={styles.pharmacyFormContainer}>
            ...
            <TextInput
                ...
                value={pharmacyForm.contactNumber}
            ...
            <TextInput
                ...
                value={pharmacyForm.zipCode}
                onChangeText={(value) => handleInputChange('zipCode', value)}
            />
            <Button title="Pick Open Time" onPress={() => setShowOpenTimePicker(true)} />
            {showOpenTimePicker && (
                <DateTimePicker
            ...
            <Button title="Pick Close Time" onPress={() => setShowCloseTimePicker(true)} />
            {showCloseTimePicker && (
                <DateTimePicker
